...
<div class="col-lg-9 mt-2">
    <div class="card">
        <h5 class="card-header bg-warning text-light">Total Penjualan</h5>
        <div class="card-body">
            <?php 
            $total= 0;
            if(empty($result)) {
       ...
       <div class="column d-flex justify-content-start">
                <a href="perbulan" class="btn <?php echo (empty($result)) ? "btn-warning disabled" : "btn-light" ; ?> me-2" > Perbulan</a>
          </div>
       </div>
            </div>
